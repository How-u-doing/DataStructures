...
int main()
{
	...
	for (int i = 0; i < N; i++){
		...
		//strcpy(arr1[i].addr, "Berlin"); // small string
		strcpy(arr1[i].addr, "This is a large string of 360 charactars; This is a large string of 360 charactars"
			"This is a large string of 360 charactars; This is a large string of 360 charactars"
			"This is a large string of 360 charactars; This is a large string of 360 charactars"
			"This is a large string of 360 charactars; This is a large string of 360 charactars"
			"This is a large string of 360 c");
