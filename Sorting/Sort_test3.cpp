...
void counting_bucket_sort_tests()
{
	...
	sa::counting_sort(s.begin(), s.end());
	cout << s << '\n';

	sa::counting_sort_unstable(vuc.begin(), vuc.end());
	for (auto x : vuc) {
	    cout << x;
	}
	cout << '\n';
	...
	sa::counting_sort_ext/*_unstable*/(vi.begin(), vi.end());
	//sa::bucket_sort(vi.begin(), vi.end(), 20);
	for (auto x : vi) {
	    cout << x << "  ";
	}
	cout << '\n';
	...
	sa::bucket_sort(vf.begin(), vf.end(), 10);
	for (auto x : vf) {
	    cout << x << "  ";
	}
	cout << '\n';
...
void radix_sort_tests()
{
	...
	//sa::radix_sort(cards, cards + 13, 7);
	sa::radix_sort(cards.begin(), cards.end(), 7);
	cout << "\nRadix sorting an array of c++ strings: \n";
	...
	vector<const char*> cards2 = {
							...
							"2RLA629",
							"3ATW723" };
	//sa::radix_sort(cards2, cards2 + 13, 7);
	sa::radix_sort(cards2.begin(), cards2.end(), 7);
	cout << "\nRadix sorting an array of c strings (const char*): \n";
