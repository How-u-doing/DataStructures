...
int main()
{
    ...
    int n1 = 10;
    mysa::quickselect(s1.begin(), s1.begin() + n1, s1.end()/*, greater<int>{}*/);
    for (int a : s1) {
        cout << a << " ";
    }
    ...
    int n2 = 13;
    mysa::partial_quicksort(s2.begin(), s2.begin() + n2, s2.end()/*, greater<int>{}*/);
    for (int a : s2) {
        cout << a << " ";
    }
    ...
    int n3 = 5;
    mysa::partial_sort(s3.begin(), s3.begin() + n3, s3.end(), greater<int>{});
    for (int a : s3) {
        cout << a << " ";
    }
    cout << '\n';
